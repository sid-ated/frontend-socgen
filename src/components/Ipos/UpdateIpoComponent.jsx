...
class UpdateIpoComponent extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount(){
        IpoService.getIpoById(this.state.id).then( (res) =>{
            let ipo = res.data;
            this.setState({price: ipo.price,
                totalNumber: ipo.totalNumber,
                timestamp: ipo.timestamp,
                remarks: ipo.remarks,
                company: {id: ipo.company.id},
                stockExchange: {id: ipo.stockExchange.id}
            });
        });
    ...
    updateIpo = (e) => {
        ...
        IpoService.updateIpo(ipo, this.state.id).then( res => {
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.updateIpo}>Save</button>
...
export default UpdateIpoComponent
